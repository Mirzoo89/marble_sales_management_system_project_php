<?php 
    ...
    isset($_SESSION['ManagerLogedIn']) AND $_SESSION['ManagerLogedIn']==true){
        ...
        $selectQuery="SELECT * FROM receipt_payment JOIN customer ON customer.id=receipt_payment.customer_id WHERE customer_id='$id' AND rp_type='receipt'";
...
<div class="container">
	<div class="row">
		<h1 class="profile display-4 text-center mt-3 form-control bg-primary text-white">Receipt Payment Detail</h1>
		...
		<div class="col-md-12 col-12 mt-2" id="datt">
			...
			<div class="row mt-3">
				<div class="col-6 ">
					<h6 class="mt-2 mb-3">Customer Name: <u><?php echo $r['customer_name']?></u></h6>
				</div>
			...
			<table id="tbl" class="table text-center border table-striped">
		    	<thead>
		    		<tr>
		    			<th>Date</th>
		    			<th>Amount</th>
		    	...
		    	<tbody>
		    		<?php 
		    			while($row=mysqli_fetch_assoc($results)){
       					...
       					// Total Amount
		    			$selt="SELECT sum(rp_amount) as Total FROM receipt_payment WHERE customer_id='$id' AND rp_type='receipt'";
		    		...
		    		?>
		    		<tr class="bg-dark">
		    			<th class="text-danger text-center"><b>Total:</b></th>
			...
			<div class="col-4">
				<a href="receipt.php" class="btn btn-primary mr-3 mt-3">Back</a>
    	 ...
    	 $(document).on('click','#print',function(){
          	...
          	var HTML='';
            	HTML+='<html><head><title>Print</title>';
              	...
              	HTML+='<body onload="window.print();"><div class="container">';
              		
              		// HTML+='<h2 class="text-center mt-5">SADIQ MARBLES FACTORY</h2>';
              		// HTML+='<p class="text-center">0333-6694089 / 0305-7454389 <br> Faisalabad Road Samundri Near WAPDA House </p>';
              		// HTML+='<br>';
